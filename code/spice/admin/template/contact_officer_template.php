                                    ...
                                    <table width='100%' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-size: 15px; margin: 0;'>
                                        <tr style='margin: 0;'>
                                            <td class='content-block' style='vertical-align: top; margin: 0; padding: 0 0 20px;' valign='top'>
                                                Hi Agent, received a new request / Feedback.
                                            </td>
                                        </tr>
                                        <tr style='margin: 0;'>
                                            <td class='content-block' style='vertical-align: top; margin: 0; padding: 0 0 20px;' valign='top'>
                                                <table>
                                                    <tr style='vertical-align: top;'>
                                                        ...
                                                        <td style='max-width: 60%; padding-left: 20px;'>
                                                            <p style='margin: 0;'>Customer Name : <?php echo $customer; ?></p>
                                                            <p style='margin: 0;'><a href='mailto:<?php echo $customerEmail; ?>'>Customer E-mail : <?php echo $customerEmail; ?></a></p>
