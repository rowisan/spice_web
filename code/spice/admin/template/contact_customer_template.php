                                    ...
                                    <table width='100%' cellpadding='0' cellspacing='0' style='box-sizing: border-box; font-size: 15px; margin: 0;'>
                                        <tr style='margin: 0;'>
                                            <td class='content-block' style='vertical-align: top; margin: 0; padding: 0 0 20px;' valign='top'>
                                                Hi <strong style='margin: 0;'><?php echo $customer; ?></strong> Thank you for contact with us.
                                            </td>
                                        </tr>
                                        <tr style='margin: 0;'>
                                            <td class='content-block' style='vertical-align: top; margin: 0; padding: 0 0 20px;' valign='top'>
                                                <table>
                                                    <tr style='vertical-align: top;'>
                                                        <td style='max-width: 60%; padding-left: 20px;'>
                                                            <p style='float: left;'>
                                                                <br>
                                                                We have received your request / Feedback and one of our staff member will reply to it soon. Thank you for contacting <?php echo $companyName; ?>.
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
