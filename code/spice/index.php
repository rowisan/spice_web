...
<div id="minimal-bootstrap-carousel" class="carousel default-home-slider slide carousel-fade shop-slider" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active slide-1" style="background-image: url(<?php echo $host; ?>images/slider/10.jpg);backgroudn-position: center right;">
        ...
        <div class="item  slide-2" style="background-image: url(<?php echo $host; ?>images/slider/11.jpg);backgroudn-position: center right;">
        ...
        <div class="item  slide-2" style="background-image: url(<?php echo $host; ?>images/slider/12.jpg);backgroudn-position: center right;">
        ...
        <div class="roomsuite-slider-two">
            ...
            foreach ($objProductList as $value) {
                ...
                <div class="product-suite product-suite-htwo">
                    <div class="item">
                        <div class="ro-img"><img src="<?php echo $host; ?>images/products/<?php echo trim($value['item_code']); ?>/1.jpg" class="img-responsive" alt="">
                        </div>
                        <div class="ro-txt">
                            <h2><?php echo trim($value['name']); ?></h2>
                            <p><?php echo trim($value['short_description']); ?></p>
                            <div class="ro-text-two">
                                <div class="left-p-two "><a href="<?php echo $host; ?><?php echo trim($value['item_code']); ?>" class="more">Read More &nbsp; <i class="fa fa-angle-double-right "></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-img-box1">
                    <div class="spa-offer">
                        <div class="img_holder">
                            <img src="<?php echo $host; ?>images/history/4.png" class="img-responsive" alt="">
                            <!--                                    <div class="overlay">
...
<!-- jQuery appear -->
<script src="<?php echo $host; ?>vendors/jquery-appear/jquery.appear.js"></script>
<!-- jQuery countTo -->
<script src="<?php echo $host; ?>vendors/jquery-countTo/jquery.countTo.js"></script>
